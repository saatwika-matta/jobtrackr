...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { applied_date: @job_application.applied_date, company_name: @job_application.company_name, follow_up_date: @job_application.follow_up_date, job_url: @job_application.job_url, notes: @job_application.notes, role_title: @job_application.role_title, status: @job_application.status } }
    end
